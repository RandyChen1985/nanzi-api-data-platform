...
| `/api/portal/lab/*` (增强) | `test_sql_risk.py`, `test_lab_enhancements.py` | **风险检测、保存查询、分析会话、导出列表、表收藏、表探索器搜索** | ✅ 通过 | 2026-07-12   |
...
| `nanzi_mcp` (stdio/SSE) | 手动 | MCP Server 工具与系统配置开关 | ⏳ 待验 | 2026-07-01 |
